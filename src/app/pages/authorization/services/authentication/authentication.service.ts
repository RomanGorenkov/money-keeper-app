...
export class AuthenticationService {
  ...
  login(loginFormData: FormGroup) {
    ...
    this.sendLoginData(formData.email, formData.password).subscribe(loginAnswer => {
  ...
  registration(registrationFormData: FormGroup) {
    ...
    this.sendRegistrationData(formData).subscribe(() => this.router.navigate([roads.authorisation.login]))
  }
