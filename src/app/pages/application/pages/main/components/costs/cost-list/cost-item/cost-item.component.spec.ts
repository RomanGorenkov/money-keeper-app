...
describe('ExpenseItemComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CostItemComponent, ImageWithMaskComponent],
      providers: [
        {
  ...
  describe('test openModal function should open different modal window by switcher type', () => {
    ...
    it('test openModal function should open AddCostModalWindowComponent by today switcher', () => {
    ...
    it('test openModal function should open AddCostModalWindowComponent by custom switcher', () => {
