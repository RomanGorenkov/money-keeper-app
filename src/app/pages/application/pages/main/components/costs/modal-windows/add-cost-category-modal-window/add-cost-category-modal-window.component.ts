...
export class AddCostCategoryModalWindowComponent implements OnInit {
  ...
  constructor(private costCategoryService: CostCategoryService, private dialog: DialogService) {}
  ...
  addNewCostCategory(event) {
    ...
    this.costCategoryService.addNewUserCostCategory(data).subscribe(imageUrl => {
