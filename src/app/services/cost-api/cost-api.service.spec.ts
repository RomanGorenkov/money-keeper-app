...
describe('CostApiService', () => {
  ...
  it('should test getTodayAllUserCosts function return full UserCosts[]', () => {
    ...
    costApiService.getTodayAllUserCosts().subscribe(userCosts => {
  ...
  it('should test getCurrentAllUserCosts function return filtered UserCosts[] by time interval', () => {
    ...
    costApiService.getCurrentAllUserCosts(startDate, endDate).subscribe(userCosts => {
    ...
    const req = httpTestingController.expectOne(
      `${environment.serverUrl}/${apiUrls.getAllUserCosts}/${startDate}/${endDate}`
    )
  ...
  it('should test addCost function send cost data', () => {
    ...
    costApiService.addCost(mockCost).subscribe()
